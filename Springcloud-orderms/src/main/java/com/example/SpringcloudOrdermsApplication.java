...
@EnableDiscoveryClient // make registeration of our microservcices into consul
@EnableSwagger2
public class SpringcloudOrdermsApplication {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("TollUsage MS").description("Toll Microservice")
				.termsOfServiceUrl("http://sg.com").contact("xyz").license("Xyz license").version("3.0").build();
	}
}
